...
int main(int argc, char const *argv[])
{
    ...
    while (salir == false)
    {
        ...
        cout << endl;
        cout << "Elija la opcion con la cual desea hacer la busqueda: "<<endl;
        cout << "1.Por descripcion del libro: "<<endl;
        cout << "2.Por autor del libro: "<<endl;
        cin >> opcion;

        if (opcion==1){
        cout << "Opcion 1: Ingrese la descripcion del libro que desea buscar: ";
        cout << endl;
        cin>> buscar;
        ...
        {
        cout << endl;
        cout << " Opcion 2: Ingrese el nombre del autor del libro que desea buscar: ";
        cout << endl;
        cin>> buscar;
            ...
            for (int i = 0; i < 39; i++)
        {
            ...
            if (autorEnminuscula.find(buscar) != string::npos ) {
                cout << "Libro encontrado: " << libro << "      Autor: " << autor<< endl<< endl;
